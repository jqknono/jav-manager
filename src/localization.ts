...
const strings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    gui_error_local_search: "Local search error: {0}",
    gui_error_remote_search: "Remote search error: {0}",
    gui_status_search_complete: "Search complete",
    gui_status_local_search_complete: "Local search complete",
    gui_status_remote_search_complete: "Remote search complete",
    gui_status_local_and_remote_complete: "Local & remote search complete",
    gui_search_results: "Search Results",
    gui_select_detail: "Detail",
    gui_back_to_results: "Back to Results",
    gui_table_source: "Source",
    gui_table_actors: "Actors",
    gui_table_date: "Release Date",
    gui_settings_test: "Test",
    gui_settings_test_ok: "Connection OK",
    gui_settings_test_fail: "Connection failed: {0}",
    gui_settings_testing: "Testing...",
    gui_open_file: "Open",
    gui_open_folder: "Folder",
    gui_nav_javdb: "JavDB",
    gui_nav_everything: "Everything",
    gui_nav_qbittorrent: "qBittorrent",
    gui_theme_dark: "Dark",
    gui_theme_light: "Light",
    gui_link_javdb: "https://javdb.com/",
    gui_link_everything: "https://www.voidtools.com/everything-1.5a/",
    gui_link_qbittorrent: "https://github.com/qbittorrent/qBittorrent",
  ...
  zh: {
    app_name: "JavManager",
    help_title: "命令",
    help_search: "search <番號>   搜尋並下載",
    help_local: "local <關鍵字>  本地檔案搜尋",
    help_remote: "remote <番號>   僅遠端搜尋",
    help_cache: "cache           快取統計",
    help_downloads: "downloads       下載列表",
    help_downloading: "downloading     下載中列表",
    help_health: "health          健康檢查",
    help_lang: "lang <en|zh|ja|ko> 切換語言",
    help_version: "version         版本資訊",
    help_help: "help            說明",
    help_quit: "quit            退出交互",
    prompt_input: "輸入命令或番號",
    invalid_jav_id: "番號格式無效: {0}",
    searching: "正在搜尋: {0}",
    no_search_results: "無搜尋結果",
    no_torrents_found: "未找到種子",
    local_files_found: "發現本地檔案",
    ...
    gui_title: "JavManager",
    gui_nav_search: "搜尋",
    gui_nav_downloads: "下載",
    gui_nav_settings: "設定",
    gui_nav_repo: "程式碼倉庫",
    gui_nav_cloudflare: "社群",
    gui_section_local_files: "本地檔案",
    gui_section_torrents: "種子",
    gui_search_button: "搜尋",
    gui_download_button: "下載",
    gui_status_ready: "就緒",
    gui_status_searching: "正在搜尋...",
    gui_status_download_added: "已新增下載任務",
    gui_status_download_failed: "下載失敗",
    gui_settings_save: "儲存設定",
    gui_settings_saved: "設定已儲存",
    gui_label_jav_id: "番號",
    gui_placeholder_jav_id: "如 ABC-123",
    gui_label_search_local: "本地",
    gui_label_search_remote: "遠端",
    gui_table_title: "標題",
    gui_table_size: "大小",
    gui_table_name: "名稱",
    gui_table_state: "狀態",
    ...
    gui_settings_section_qbittorrent: "qBittorrent",
    gui_settings_section_javdb: "JavDB",
    gui_settings_section_download: "下載",
    gui_settings_section_language: "語言",
    gui_field_base_url: "基礎 URL",
    gui_field_username: "使用者名稱",
    gui_field_password: "密碼",
    gui_field_mirror_urls: "鏡像位址（逗號分隔）",
    gui_field_default_save_path: "預設儲存路徑",
    gui_field_default_category: "預設分類",
    gui_field_default_tags: "預設標籤",
    gui_error_qb_not_configured: "qBittorrent 尚未設定。請在 {0} 中設定 qBittorrent Base URL。",
    gui_error_everything_not_configured: "Everything 尚未設定。請在 {0} 中設定 Everything Base URL。",
    gui_error_local_search: "本地搜尋錯誤: {0}",
    gui_error_remote_search: "遠端搜尋錯誤: {0}",
    gui_status_search_complete: "搜尋完成",
    gui_status_local_search_complete: "本地搜尋完成",
    gui_status_remote_search_complete: "遠端搜尋完成",
    gui_status_local_and_remote_complete: "本地及遠端搜尋完成",
    gui_search_results: "搜尋結果",
    gui_select_detail: "詳情",
    gui_back_to_results: "返回結果",
    gui_table_source: "來源",
    gui_table_actors: "演員",
    gui_table_date: "发行日期",
    gui_settings_test: "測試",
    gui_settings_test_ok: "連線成功",
    gui_settings_test_fail: "連線失敗: {0}",
    gui_settings_testing: "正在測試...",
    gui_open_file: "開啟",
    gui_open_folder: "資料夾",
    gui_nav_javdb: "JavDB",
    gui_nav_everything: "Everything",

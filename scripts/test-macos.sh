#!/usr/bin/env bash
# =============================================================================
# test-macos.sh - Run JavManager unit tests on macOS
#                 在 macOS 上运行 JavManager 单元测试
#
# Description:
#   Executes the xUnit test suite for JavManager on macOS. Optionally runs
#   the JavDB connection diagnostic after tests complete.
#   在 macOS 上执行 JavManager 的 xUnit 测试套件。可选在测试完成后
#   运行 JavDB 连接诊断。
#
# Options:
